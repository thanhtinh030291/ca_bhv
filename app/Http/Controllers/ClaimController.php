...
class ClaimController extends Controller
{
    ...
    public function letter($letter_template_id , $claim_id ,$export_letter_id = null){
        ...
        $OTHERGOP = $HBS_CL_CLAIM->HBS_CL_LINE->whereNotIn('PD_BEN_HEAD.ben_head',['RB','SUR','OPR','ANES','EXTB','ICU','CCU'])->sum('app_amt');
        ...
        $content = str_replace('[[$RBGOP]]', formatPrice(round($RBGOP)), $content);
