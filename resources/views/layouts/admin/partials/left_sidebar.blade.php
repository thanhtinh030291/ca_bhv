            ...
            <ul>
                ...
                <li class="submenu">
                    ...
                    <ul class="list-unstyled">
                        @hasanyrole('Header|Manager|Admin|Claim|Claim Independent|Lead|QC|Supper|AdminClaim')
                        ...
                        @endhasanyrole
                        @hasanyrole('Header|ManagerGOP|Admin|Lead|Manager|Claim Independent|Supper')
