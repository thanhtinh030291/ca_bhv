<div class="table-responsive">
    <table class="table" id="reportAdmins-table">
        ...
        <tbody>
        @foreach($CPS_PAYMENTS as $CPS_PAYMENT)
            <tr>
            <td>{!! $CPS_PAYMENT->date !!}</td>
            {{-- <td>{!! $reportAdmin->total !!}</td> --}}<td></td>
            {{-- <td></td>
            <td></td> --}}
            <td>
                <a href="{!! route('ReportPaymentFN.show', $CPS_PAYMENT->date) !!}" class='btn btn-success btn-xs'><i class="fa fa-eye"></i></a>
